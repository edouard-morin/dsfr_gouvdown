...
(function () {
  ...
  */
  ...
  var NO_REDUCE$1 = ":not(" + (api.internals.ns.attr.selector('analytics-action', 'reduce')) + ")";

  var TranscriptionSelector = {
    TRANSCRIPTION: TRANSCRIPTION,
    COLLAPSE: (TRANSCRIPTION + " > " + COLLAPSE$1 + NO_REDUCE$1 + ", " + TRANSCRIPTION + " > *:not(" + TRANSCRIPTION + "):not(" + COLLAPSE$1 + ") > " + COLLAPSE$1 + NO_REDUCE$1 + ", " + TRANSCRIPTION + " > *:not(" + TRANSCRIPTION + "):not(" + COLLAPSE$1 + ") > *:not(" + TRANSCRIPTION + "):not(" + COLLAPSE$1 + ") > " + COLLAPSE$1 + NO_REDUCE$1),
  ...
  var NO_REDUCE = ":not(" + (api.internals.ns.attr.selector('analytics-action', 'reduce')) + ")";
