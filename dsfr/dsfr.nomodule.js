...
(function () {
  ...
  var Root = /*@__PURE__*/(function (Element) {
    ...
    Root.prototype.interaction = function interaction (e) {
  ...
  var DANGEROUS_PROTOCOL = /^\s*(?:javascript|data|vbscript)\s*:/i;
  var DANGEROUS_CSS = /@import|expression\s*\(|url\s*\(\s*['"]?\s*(?:javascript|data|vbscript):|behavior\s*:|-moz-binding/i;
  ...
  function sanitizeElement (element) {
    for (var i$1 = 0, list$1 = Array.from(element.childNodes); i$1 < list$1.length; i$1 += 1) {
      var child = list$1[i$1];
      ...
      if (child.nodeType === Node.ELEMENT_NODE) {
        ...
        for (var i = 0, list = Array.from(child.attributes); i < list.length; i += 1) {
          var attr = list[i];
          ...
          if (name === 'style') {
            var sanitizedStyle = sanitizeCssContent(attr.value);
        ...
        if (tag === 'style') {
          var sanitizedStyleContent = sanitizeCssContent(child.textContent);
  ...
  function sanitizeSvg (svg) {
    ...
    for (var i = 0, list = Array.from(svg.attributes); i < list.length; i += 1) {
      var attr = list[i];
  ...
  function isSameOrigin (url) {
    ...
    try {
      ...
      var protocol = (link.protocol || window.location.protocol).toLowerCase();
      if (protocol !== 'http:' && protocol !== 'https:') { return false; }

      var hostname = link.hostname || window.location.hostname;
      var port = link.port || (protocol === 'https:' ? '443' : '80');
      ...
      if (this.img) {
        ...
        fetch(this.imgURL)
          ...
          .then(function (response) {
            ...
            var rawSvg = xmlDoc.querySelector('svg');

            if (rawSvg) {
              this$1$1.svg = sanitizeSvg(rawSvg);
              this$1$1.replace();
            }
          });
      }
    ...
    Artwork.prototype.fetch = function fetch () {
      ...
      xhr.onload = function () {
        ...
        if (this$1$1.realSvgContent) {
          sanitizeSvg(this$1$1.realSvgContent);
          if (this$1$1.realSvgContent.tagName === 'symbol') {
            var expectedHref = "#" + (this$1$1.svgName);
            ...
            if (this$1$1.use) {
              sanitizeSvg(this$1$1.use);
              this$1$1.node.parentNode.insertBefore(this$1$1.use, this$1$1.node);
            }
          } else {
  ...
  var ModalFooter = /*@__PURE__*/(function (superclass) {
    function ModalFooter () {
      superclass.apply(this, arguments);
    }

    if ( superclass ) ModalFooter.__proto__ = superclass;
    ModalFooter.prototype = Object.create( superclass && superclass.prototype );
    ModalFooter.prototype.constructor = ModalFooter;
    ...
    ModalFooter.prototype.init = function init () {
      this.isResizing = true;
    };

    ModalFooter.prototype.resize = function resize () {
      this.adjust();
    };

    ModalFooter.prototype.adjust = function adjust () {
      var height = this.getRect().height;
      this.node.parentNode.style.setProperty('--modal-scroll-padding-bottom', (height + "px"));
    };

    Object.defineProperties( ModalFooter, staticAccessors );
  ...
  var Navigation = /*@__PURE__*/(function (superclass) {
    ...
    Navigation.prototype.handleClick = function handleClick (e) {
      var linkOrButton = e.target.closest('a, button');
  ...
  */
  var TabsGroup = /*@__PURE__*/(function (superclass) {
    ...
    TabsGroup.prototype.focus = function focus () {
      ...
      var button = this.current.primaryButtons.find(function (button) { return button.list === this$1$1.list; });
  ...
  var Display = /*@__PURE__*/(function (superclass) {
    ...
    Display.prototype.disableChoices = function disableChoices () {
